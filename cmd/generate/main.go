...
func main() {
	...
	baseDir := flag.String("base-dir", "data/src", "The base directory for version JSON files")
	outputDirFlag := flag.String("output-dir", "out", "The output directory of the generated Go code")
	...
	fieldsDir := filepath.Join(wd, *baseDir)
